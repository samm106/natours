...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FtZWVyc2F4ZW5hIiwiYSI6ImNrYWg0MHBncTBhNXkycWxzcXM1a2Y1bHYifQ.ollebxASc6Enwkfas74GsQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sameersaxena/ckah56i6i0tob1iltyl6xp1ov',
    scrollZoom: false // center: [34.111745, -118.113491],
    // zoom: 10,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p> </p>")).addTo(map);
...
var stripe = Stripe('pk_test_YcBeei2ZUpIfzivHEWYAPKAq00NRoQyVm4');
